...
interface DBConstants {
    ...
    static final String SELECT_RANDOM_CLOSED_QUESTIONS_BY_CAT = "SELECT DISTINCT * FROM " + QUESTIONS_TABLE +
            " WHERE " + QUESTION_TYPE + "=" + CLOSED_TYPE_QUESTION + " AND " + QUESTION_CATEGORY + "=? ORDER BY RANDOM() LIMIT ?";

    static final String SELECT_RANDOM_OPEN_QUESTIONS_BY_CAT = "SELECT DISTINCT * FROM " + QUESTIONS_TABLE +
            " WHERE " + QUESTION_TYPE + "=" + OPEN_TYPE_QUESTION + " AND " + QUESTION_CATEGORY + "=? ORDER BY RANDOM() LIMIT ?";

    static final String SELECT_CAT_ID_BY_NAME = "SELECT " + CATEGORY_ID + " FROM " + CATEGORIES_TABLE + " WHERE " + CATEGORY_NAME + " =?";
